                      ...
                      <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    ...
                                    <span class="text-truncate text-truncate-xl"><?php echo $user['jobs'];?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:<?php echo $user['mobile'];?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i> <?php echo $user['mobile'];?></a>
                                ...
                                <div class="d-flex flex-row">
                                    <a href="<?php echo $user['facebook'];?>" class="mr-2 fs-xxl" style="color:#3b5998">
                                        <i class="fab fa-facebook-square"></i>
                                    </a>
                                    <a href="<?php echo $user['twitter'];?>" class="mr-2 fs-xxl" style="color:#38A1F3">
                                        <i class="fab fa-twitter-square"></i>
                                    </a>
                                    <a href="<?php echo $user['linkedin'];?>" class="mr-2 fs-xxl" style="color:#0077B5">
